...
import 'warnings_api.dart';

/// Main APIService for Warnings endpoint
///
/// This will create a singleton instance
///
class WarningStatusApiService {
  static bool _initialized = false;
  static const String _tag = '.WarningAPIService';
  static WarningStatusApiService _apiService = WarningStatusApiService._();
  static Dio _client;
  static WarningsAbstractApi _configApi;

  WarningStatusApiService._();

  bool get _notInitialized => !_initialized;

  static WarningStatusApiService get api => _apiService;

  @visibleForTesting
  set setMockInstance(WarningStatusApiService instance) =>
  ...
  Future<APIResponse> getWarnings<WarningModel>() async {
